    ...
    <Link className="chat-entry" to={`/profile/chat/${contact.id}`}> 
      ...
      <div className="info">
        <div className="top-row">
          <div className="contact-name">{contact.username2}</div>
          {contact.lastMessage && 
            <div className="date"><DateViewer value={contact.lastMessage.date}/></div>
          }
        </div>
        <div className="bottom-row">
          {contact.lastMessage && 
            <div className="message">{contact.lastMessage.message}</div>
          }
        </div>
      </div>
    </Link>
