...
function ProfileData({ updateField, user }) {
    ...
    return (
        <form 
            onSubmit={handleData} 
            className="profile-form profile-data"
        >
            ...
            <div className="profile-update-fields">
                <div className="profile-update-fields-1">
                    <div className="profile-update-field">
                        <label className="profile-update-field-label" htmlFor="profile-update-name">
                    ...
                    <div className="profile-update-field">
                        <label className="profile-update-field-label" htmlFor="profile-update-last-name">
                    ...
                    <div className="profile-update-field">
                        <label className="profile-update-field-label" htmlFor="profile-update-location">
                            <span>
                    ...
                    <div className="profile-update-field">
                        <label className="profile-update-field-label" htmlFor="profile-update-birth">
                ...
                <div className="profile-update-fields-2">
                    <div className="profile-update-field">
                        <label className="profile-update-field-label" htmlFor="profile-update-username">
                    ...
                    <div className="profile-update-field">
                        <label className="profile-update-field-label" htmlFor="profile-update-email">
                    ...
                    <div className="profile-update-field">
                        <label className="profile-update-field-label" htmlFor="profile-update-phone_number">
