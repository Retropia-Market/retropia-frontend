        ...
        <div className="transactions-main">
            <ul className="transactions-navbar">
                ...
                >
                    <li>
                        <h2>
                            <FormattedMessage id="profile.bids" />
                        </h2>
                    </li>
                </NavLink>
                ...
                >
                    <li>
                        <h2>
                            <FormattedMessage id="profile.sales" />
                        </h2>
                    </li>
                </NavLink>
                ...
                >
                    <li>
                        <h2>
                            <FormattedMessage id="profile.purchases" />
                        </h2>
                    </li>
                </NavLink>
            </ul>
            <div className="transactions-section">
                <Switch>
                    ...
                    <Route
                        path={`/profile/transactions/sell/user/${user.userData.id}`}
                    >
