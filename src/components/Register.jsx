...
function Register ({setShowRegister, setShowLogin}) {
  ...
  return <div className="register-bg">
    <form className="register-fg" onSubmit={handleSubmit}>
      ...
      <button type="button" className="register-options" onClick={handleClick}>Ya tienes cuenta?</button>
      <button className="register-button" >SIGN UP</button>
    </form>
    <FontAwesomeIcon className="register-exit" icon={faChevronUp} size="2x" onClick={() => setShowRegister(false)} ></FontAwesomeIcon>
